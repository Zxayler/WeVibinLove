...
class AutoDatingSystem(Cog, name="Blind Data System"):
	def __init__(self, bot):
		self.bot = bot

	@command(aliases=['change-auto-vc-name'], description="Sets / Changes the Auto Generated voice channel", usage="change-auto-vc-name <name>")
	...
	@command(aliases=["setup-blind-date"], description="Sets and enables the blind date in your server.", usage="setup-blind-date")
	async def setup_blind_date(self, ctx):
		...
		await ctx.send(embed=successEmbed("Blind date setup was successful, Proceed to the bottom of your server and you will see the blind date category. you can now change the category and channel permissions."))
	...
	@command(aliases=['delete-blind-date'], description="Deletes / Removes the Auto Generated voice channel", usage="delete-blind-date")
	...
	@command(description="Shows the tutorial on how to enable the blind date system in your server.", usage="tutorial")
